...
| 9. Stimulus skipped | Partial, non-diagnostic result; no punitive copy | MANUAL VERIFICATION REQUIRED | | | Automated: results status `partial` when video skipped. Skip is offered before Start and if the clip fails; Continue advances after the clip ends |
